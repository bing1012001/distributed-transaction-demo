...
public class AccountMapperTest {
    ...
    public void accountAddTest() {
        AccountInfo account = AccountInfo.builder().userId(UUID.randomUUID().toString()).balance(1200).updateTime(Timestamp.valueOf(LocalDateTime.now())).build();
    ...
    public void getAccountInfoTest() {
        AccountInfo account = accountMapper.getAccountInfo("c0eb0353-5477-44ed-8cde-4bd56552e411");
